...
#define FSAPMSDK_Notif_DomainRequestResult        @"FSAPMSDK_Notif_DomainRequestResult" //result from application layer
#define FSAPMSDK_Notif_IPValidateResult           @"FSAPMSDK_Notif_IPValidateResult" //result from ipvalidator
