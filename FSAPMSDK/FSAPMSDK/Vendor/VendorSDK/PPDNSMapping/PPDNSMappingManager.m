...
- (instancetype)init
{
    ...
    if (self) {
        ...
        //observe events
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(detectDomainRequestResult:) name:FSAPMSDK_Notif_DomainRequestResult object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(detectIPValidatorResult:) name:FSAPMSDK_Notif_IPValidateResult object:nil];
    }
    return self;
}
